...
namespace Test
{
    ...
    public class TestRedaFiksneDuljine
    {
        ...
        [TestMethod]
        public void RedFiksneDuljine_DodavanjeČetvrtogČlanaNePovećavaRedDuljineTri()
        {
            RedFiksneDuljine<Polje> r = new RedFiksneDuljine<Polje>(3);
            r.Enqueue(new Polje(0, 0));
        ...
        [TestMethod]
        public void RedFiksneDuljine_DodavanjeČetvrtogIzbacujePrviČlanIzRedaDuljineTri()
        {
            RedFiksneDuljine<Polje> r = new RedFiksneDuljine<Polje>(3);
            r.Enqueue(new Polje(0, 0));
            r.Enqueue(new Polje(1, 0));
