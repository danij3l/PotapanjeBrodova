...
namespace Test
{
    ...
    public class TestLinijskogPucača
    {
        ...
        [TestMethod]
        public void LinijskiPucač_GađajVraćaSamoSlobodnoPoljeLijevoOdHoriznontalnogNiza()
        {
            Mreza m = new Mreza(10, 10);
            Polje[] polja = { new Polje(2, 3), new Polje(2, 4) };
            m.UkloniPolje(2, 5);
        ...
        [TestMethod]
        public void LinijskiPucač_GađajVraćaSamoSlobodnoPoljeDesnoOdHoriznontalnogNiza()
        {
            Mreza m = new Mreza(10, 10);
            Polje[] polja = { new Polje(2, 3), new Polje(2, 4) };
            m.UkloniPolje(2, 5);
        ...
        [TestMethod]
        public void LinijskiPucač_GađajVraćaJednoOdDvaPoljaLijevoIliDesnoOdVertikalnogNiza()
        {
            Mreza m = new Mreza(10, 10);
        ...
        [TestMethod]
        public void LinijskiPucač_GađajVraćaSamoSlobodnoPoljeGoreOdVertiklanogNiza()
        {
            Mreza m = new Mreza(10, 10);
            Polje[] polja = { new Polje(2, 3), new Polje(3, 3) };
            m.UkloniPolje(4, 3);
