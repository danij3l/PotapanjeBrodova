...
namespace Test
{
    ...
    public class TestPolja
    {
        ...
        [TestMethod]
        public void Polje_ZaDvaPoljaKojaImajuIsteKoordinateMetodaEqualsVraæaTrue()
        {
        ...
        [TestMethod]
        public void Polje_ZaDvaPoljaKojaNemajuIstiRedakMetodaEqualsVraæaFalse()
        {
            Polje p1 = new Polje(2, 3);
        ...
        [TestMethod]
        public void Polje_ZaDvaPoljaKojaNemajuIstiStupacMetodaEqualsVraæaFalse()
        {
            Polje p1 = new Polje(2, 3);
